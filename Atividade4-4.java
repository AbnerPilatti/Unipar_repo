...
public class Atividade4-4 {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println(" Por gentileza, insira dois números inteiros e o programa irá te dizer qual será o maior.");
            while(repetir) {
                ...
                if (numero1 > numero2) {
                    ...
                    System.out.println("Os números '" + numero1 + "' e '" + numero2 + "' são identicos.");
                }
    ...
    private static boolean pegarRepetir() {
        while(true) {
            try {
                System.out.println(" Voce Deseja repetir o programa?");
